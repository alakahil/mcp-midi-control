...
- `probe-fm3-cab1-level.ts`: read-only FM3 Cab 1 Level validation (Node 24.x required)
- `probe-fm3-cab2-pan.ts`: controlled FM3 Cab 2 Pan round-trip validation (Node 24.x required)
- `probe-fm3-cab2-level.ts`: read-only FM3 Cab 2 Level validation (Node 24.x required)
