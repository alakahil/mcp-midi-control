...
const TEST = 'samples/captured/S2_AmpBass_5_Test.syx';
...
console.log('');
console.log('FM3 Amp Bass comparison');
console.log('-----------------------');
...
console.log(`Base Bass: ${base.amp.channels?.[baseScene2]?.bass}`);
console.log(`Test Bass: ${test.amp.channels?.[testScene2]?.bass}`);
