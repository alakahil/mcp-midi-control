...
const OUTPUT = 'samples/captured/TEST_Encoded_S2_AmpChannel_C.syx';
...
// A=0, B=1, C=2, D=3
writeU16LE(newBody, amp.offset, 2);
...
console.log(`Requested channel: C`);
...
if (newChannel !== 'C') {
  throw new Error(`Channel verification failed: expected C, got ${newChannel}`);
}
