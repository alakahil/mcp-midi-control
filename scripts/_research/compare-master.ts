...
const TEST = 'samples/captured/S2_AmpMaster_7_Test.syx';
...
console.log('');
console.log('FM3 Amp Master Volume comparison');
console.log('-----------------------');
...
console.log(`Base Master Volume: ${base.amp.channels?.[baseScene2]?.master_volume}`);
console.log(`Test Master Volume: ${test.amp.channels?.[testScene2]?.master_volume}`);
