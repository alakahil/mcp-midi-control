...
const TEST = 'samples/captured/S2_AmpTreble_5_Test.syx';
...
console.log('');
console.log('FM3 Amp Treble comparison');
console.log('-----------------------');
...
console.log(`Base Treble: ${base.amp.channels?.[baseScene2]?.treble}`);
console.log(`Test Treble: ${test.amp.channels?.[testScene2]?.treble}`);
