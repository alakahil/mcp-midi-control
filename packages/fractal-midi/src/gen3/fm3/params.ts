/**
 * FM3 parameter catalog — DEVICE-TRUE, mined from FM3-Edit's own binary.
 *
 * AUTO-GENERATED by
 *   scripts/_research/generate-modern-fractal-catalog.ts fm3 FM3
 * from
 *   samples/captured/decoded/modern-fractal-devicetrue-fm3.json
 * (offline, no hardware). DO NOT HAND-EDIT — re-run the generator.
 *
 * paramId provenance: FM3-Edit's OWN param tables (direct PE pattern
 ...
 * Display calibration: 1878/2021 params carry a display unit
...
export const FM3_PARAMS: readonly Param[] = [
  ...
  { family: 'CABINET', paramId: 8, name: 'CABINET_LEVEL1', displayLabel: 'Level', unit: 'db', displayMin: -40, displayMax: 0 }, // FM3 fw 13 HW: SET/GET 0 dB=65534 acked; restored -12 dB=45874
  ...
  { family: 'CABINET', paramId: 56, name: 'CABINET_ROOMSHAPE', displayLabel: 'Room Shape', unit: 'enum', displayMin: 0, displayMax: 1 }, // FM3 fw 13 HW GET-only: Hall=raw 0; Room=raw 1
  { family: 'CABINET', paramId: 57, name: 'CABINET_LFDAMPING', displayLabel: 'LF Damping', unit: 'numeric', displayMin: 0, displayMax: 10 }, // FM3 fw 13 HW GET-only: 0=raw 0; 5=raw 32767; 10=raw 65534
  { family: 'CABINET', paramId: 58, name: 'CABINET_HFDAMPING', displayLabel: 'HF Damping', unit: 'numeric', displayMin: 0, displayMax: 10 }, // FM3 fw 13 HW GET-only: 0=raw 0; 5=raw 32767; 10=raw 65534
  ...
  { family: 'CABINET', paramId: 67, name: 'CABINET_HICUT2', displayLabel: 'High Cut', unit: 'hz', displayMin: 2000, displayMax: 20000, scaling: 'log10' }, // FM3 fw 13 HW GET-only: 2000Hz=raw 0; 6000.1Hz=raw 31268; 20000Hz=raw 65534
  ...
  { family: 'CABINET', paramId: 93, name: 'CABINET_DYNACAB_R1', displayLabel: 'Position', unit: 'percent', displayMin: 0, displayMax: 100 }, // FM3 fw 13 HW: SET/GET 0%=0 acked; restored 25%=16384
  ...
  { family: 'CABINET', paramId: 97, name: 'CABINET_DYNACAB_Z1', displayLabel: 'Distance', unit: 'cm', displayMin: 0, displayMax: 24 }, // FM3 fw 13 HW: SET/GET 0 cm=0 acked; restored 10 cm=27306
  ...
  { family: 'CABINET', paramId: 65282, name: 'CABINET_NAME1', displayLabel: 'Name', unit: 'unverified' }, // device-true 65282 (III 65284 would mis-address)
  { family: 'CABINET', paramId: 65283, name: 'CABINET_NAME2', displayLabel: 'Name', unit: 'unverified' }, // device-true 65283 (III 65285 would mis-address)
  { family: 'CABINET', paramId: 65284, name: 'CABINET_LABEL1', displayLabel: 'CAB 1', unit: 'unverified' }, // device-true 65284 (III 65288 would mis-address)
  { family: 'CABINET', paramId: 65285, name: 'CABINET_LABEL2', displayLabel: 'CAB 2', unit: 'unverified' }, // device-true 65285 (III 65289 would mis-address)
  { family: 'CABINET', paramId: 65286, name: 'CABINET_BTN_MUTE1', displayLabel: 'M', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 65286 (III 65292 would mis-address)
  { family: 'CABINET', paramId: 65287, name: 'CABINET_BTN_MUTE2', displayLabel: 'M', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 65287 (III 65293 would mis-address)
  { family: 'CABINET', paramId: 65288, name: 'CABINET_BTN_SOLO1', displayLabel: 'S', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 65288 (III 65296 would mis-address)
  { family: 'CABINET', paramId: 65289, name: 'CABINET_BTN_SOLO2', displayLabel: 'S', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 65289 (III 65297 would mis-address)
  ...
  { family: 'DELAY', paramId: 48, name: 'DELAY_LFO1TARGET', displayLabel: 'Target', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  ...
  { family: 'DELAY', paramId: 85, name: 'DELAY_HOLDFDBK', displayLabel: 'Hold Feedback', unit: 'percent', displayMin: 0, displayMax: 100 }, // inferred from AM4
  { family: 'DELAY', paramId: 86, name: 'DELAY_KILLDRY', displayLabel: 'Kill Dry', unit: 'enum' }, // inferred from AM4
  { family: 'DELAY', paramId: 87, name: 'DELAY_SVFTYPE', displayLabel: 'Filter Type', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  ...
  { family: 'DISTORT', paramId: 6, name: 'DISTORT_TYPE', unit: 'enum' }, // inferred from AM4; device-true 6 (III 0 would mis-address)
  { family: 'DISTORT', paramId: 7, name: 'DISTORT_DRIVE', displayLabel: 'Gain', unit: 'knob_0_10', displayMin: 0, displayMax: 10 }, // inferred from AM4; device-true 7 (III 1 would mis-address)
  { family: 'DISTORT', paramId: 8, name: 'DISTORT_BASS', displayLabel: 'Bass', unit: 'knob_0_10', displayMin: 0, displayMax: 10 }, // inferred from AM4; device-true 8 (III 2 would mis-address)
  ...
  { family: 'DISTORT', paramId: 17, name: 'DISTORT_WSLPF', unit: 'hz', displayMin: 400, displayMax: 40000, scaling: 'linear' }, // FM3 fw 13 HW GET-only: VIEW_VALUE=40000 Hz; definition min=400 max=40000; raw 7613 -> ~5000 linear
  ...
  { family: 'DISTORT', paramId: 49, name: 'DISTORT_TRIM', displayLabel: 'Input Trim', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 49 (III 47 would mis-address)
  { family: 'DISTORT', paramId: 50, name: 'DISTORT_HARDNESS2', displayLabel: 'Tube Hardness', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 50 (III 48 would mis-address)
  { family: 'DISTORT', paramId: 51, name: 'DISTORT_MVPOSITION', displayLabel: 'Master Vol Location', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 51 (III 49 would mis-address)
  { family: 'DISTORT', paramId: 52, name: 'DISTORT_SPKRDRIVE', displayLabel: 'Speaker Drive', unit: 'knob_0_10', displayMin: 0, displayMax: 10 }, // inferred from AM4; device-true 52 (III 50 would mis-address)
  { family: 'DISTORT', paramId: 53, name: 'DISTORT_XFMATCH', displayLabel: 'XFormer Matching', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 53 (III 51 would mis-address)
  { family: 'DISTORT', paramId: 54, name: 'DISTORT_SCREENFREQ', displayLabel: 'Screen Frequency', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 54 (III 52 would mis-address)
  { family: 'DISTORT', paramId: 55, name: 'DISTORT_SCREENQ', displayLabel: 'Screen Q', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 55 (III 53 would mis-address)
  { family: 'DISTORT', paramId: 56, name: 'DISTORT_SATSWITCH', displayLabel: 'Saturation Switch', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 56 (III 54 would mis-address)
  { family: 'DISTORT', paramId: 57, name: 'DISTORT_EQ1', displayLabel: 'Bass', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 57 (III 55 would mis-address)
  { family: 'DISTORT', paramId: 58, name: 'DISTORT_EQ2', displayLabel: 'Mid', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 58 (III 56 would mis-address)
  { family: 'DISTORT', paramId: 59, name: 'DISTORT_EQ3', displayLabel: 'Treble', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 59 (III 57 would mis-address)
  { family: 'DISTORT', paramId: 60, name: 'DISTORT_EQ4', displayLabel: 'Presence', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 60 (III 58 would mis-address)
  { family: 'DISTORT', paramId: 61, name: 'DISTORT_EQ5', displayLabel: '1600', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 61 (III 59 would mis-address)
  ...
  { family: 'DISTORT', paramId: 103, name: 'DISTORT_VARIAC', displayLabel: 'Variac', unit: 'percent', displayMin: 0, displayMax: 100 }, // inferred from AM4; device-true 103 (III 101 would mis-address)
  { family: 'DISTORT', paramId: 104, name: 'DISTORT_INEQTYPE', displayLabel: 'Type', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 104 (III 102 would mis-address)
  ...
  { family: 'DISTORT', paramId: 112, name: 'DISTORT_EQPOSITION', displayLabel: 'Location', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 112 (III 110 would mis-address)
  ...
  { family: 'DISTORT', paramId: 138, name: 'DISTORT_SPKRBREAKUP', displayLabel: 'Speaker Breakup', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 138 (III 136 would mis-address)
  { family: 'DISTORT', paramId: 139, name: 'DISTORT_SPKRTHUMP', displayLabel: 'Speaker Thump', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 139 (III 137 would mis-address)
  { family: 'DISTORT', paramId: 140, name: 'DISTORT_PLATEDIODE', displayLabel: 'Plate Suppr. Diodes', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 140 (III 138 would mis-address)
  { family: 'DISTORT', paramId: 141, name: 'DISTORT_GLOBALMASTER', displayLabel: 'Global MV', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 141 (III 139 would mis-address)
  { family: 'DISTORT', paramId: 142, name: 'DISTORT_AUTO_SPKR_Z', displayLabel: 'Auto Dyna-Cab Imp.', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 142 (III 140 would mis-address)
  { family: 'DISTORT', paramId: 143, name: 'DISTORT_NFBCOMP', displayLabel: 'NFB Compensation', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 143 (III 141 would mis-address)
  ...
  { family: 'FLANGER', paramId: 14, name: 'OLD_FLANGER_BYPASSMODE', displayLabel: 'Bypass Mode', unit: 'unverified' },
  ...
  { family: 'FLANGER', paramId: 16, name: 'OLD_FLANGER_BYPASS', displayLabel: 'Bypass', unit: 'unverified' },
  ...
  { family: 'GLOBAL', paramId: 45, name: 'GLOBAL_IN2_TRIM', displayLabel: 'Input 2 Pad', unit: 'numeric' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 48, name: 'GLOBAL_OUT1_CONFIG', displayLabel: 'Mode', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 49, name: 'GLOBAL_OUT2_CONFIG', displayLabel: 'Mode', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 52, name: 'GLOBAL_OUT1_PHASE', displayLabel: 'Phase', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 53, name: 'GLOBAL_OUT2_PHASE', displayLabel: 'Phase', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 56, name: 'GLOBAL_OUT1_PAD', displayLabel: 'Output Level', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 57, name: 'GLOBAL_OUT2_PAD', displayLabel: 'Boost/Pad', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 60, name: 'GLOBAL_COPY_OUTPUT', displayLabel: 'Output 2 Copy', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 61, name: 'GLOBAL_IN1_SOURCE', displayLabel: 'Input 1 Source', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 63, name: 'GLOBAL_AES_SOURCE', displayLabel: 'SPDIF Out Source', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 66, name: 'GLOBAL_FC_HOLD_TIMEOUT', displayLabel: 'Hold Function Timeout', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 67, name: 'GLOBAL_FC_BANKSIZE', displayLabel: 'Bank Size', unit: 'numeric' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 68, name: 'GLOBAL_MIDI_CHAN', displayLabel: 'MIDI Channel', unit: 'numeric' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 69, name: 'GLOBAL_MIDI_PROG_CHANGE', displayLabel: 'Program Change', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 70, name: 'GLOBAL_NO_REDUNDANT_PC', displayLabel: 'Ignore Red. PC', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 71, name: 'GLOBAL_PC_OFFSET', displayLabel: 'MIDI PC Offset', unit: 'numeric' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 72, name: 'GLOBAL_DISPLAY_OFFSET', displayLabel: 'Display Offset', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 73, name: 'GLOBAL_SEND_MIDIPC', displayLabel: 'Send MIDI PC', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 93, name: 'GLOBAL_SCENE_REVERT', displayLabel: 'Scene Revert', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 96, name: 'GLOBAL_CUSTOM_SCALE', displayLabel: 'Custom Scale #', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 97, name: 'GLOBAL_MIDI_MAPPING', unit: 'unverified' },
  { family: 'GLOBAL', paramId: 99, name: 'GLOBAL_USB_OUTEP_BUFF_SIZE', displayLabel: 'USB Buffer Size', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 100, name: 'GLOBAL_TUNER_SOURCE', displayLabel: 'Source', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 104, name: 'GLOBAL_CC_BYPASS_TYPE', displayLabel: 'Eff. Bypass Mode', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 105, name: 'GLOBAL_DEFAULT_SCENE', displayLabel: 'Default Scene', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 106, name: 'GLOBAL_PRESET_PROMPT', displayLabel: 'Prompt on Edit', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  ...
  { family: 'GLOBAL', paramId: 3602, name: 'GLOBAL_FC_DEFAULT_LAYOUT_PFC1', displayLabel: '1', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3603, name: 'GLOBAL_FC_DEFAULT_LAYOUT_PFC2', displayLabel: '2', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3604, name: 'GLOBAL_FC_DEFAULT_LAYOUT_PFC3', displayLabel: '3', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3605, name: 'GLOBAL_FC_DEFAULT_LAYOUT_PFC4', displayLabel: '4', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3606, name: 'GLOBAL_FC_CLONE_PFC1', displayLabel: '1', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3607, name: 'GLOBAL_FC_CLONE_PFC2', displayLabel: '2', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3608, name: 'GLOBAL_FC_CLONE_PFC3', displayLabel: '3', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3609, name: 'GLOBAL_FC_CLONE_PFC4', displayLabel: '4', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 3610, name: 'GLOBAL_FC_LAYOUT_SWITCHCFG_BEGIN', unit: 'unverified' },
  { family: 'GLOBAL', paramId: 5995, name: 'GLOBAL_FC_MLM_DISABLED', displayLabel: 'Master Layout "Switch Combo"', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 6113, name: 'GLOBAL_FC_PERPRESETS_DISABLED', displayLabel: 'Per-Preset Overrides', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  ...
  { family: 'GLOBAL', paramId: 7107, name: 'GLOBAL_CS1_EXCLUSIVE', displayLabel: 'CS1 Exclusive', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 7108, name: 'GLOBAL_CS2_EXCLUSIVE', displayLabel: 'CS2 Exclusive', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  { family: 'GLOBAL', paramId: 7109, name: 'GLOBAL_CS3_EXCLUSIVE', displayLabel: 'CS3 Exclusive', unit: 'enum' }, // inferred from AxeEdit III XML controlType
  ...
  { family: 'GLOBAL', paramId: 7424, name: 'GLOBAL_USB_3_4_PLAYBACK', displayLabel: 'USB 3,4 Playback Destination', unit: 'unverified' },
  { family: 'GLOBAL', paramId: 7425, name: 'GLOBAL_FC_FC6_FC12_MODE', displayLabel: 'FC6 Layout Mode', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 7425 (III 7499 would mis-address)
  { family: 'GLOBAL', paramId: 8293, name: 'GLOBAL_FC_FS_TUNER_MODE', displayLabel: 'Footswitch Tuner Mode', unit: 'unverified' },
  { family: 'GLOBAL', paramId: 8294, name: 'GLOBAL_FC_FS_INVERT', displayLabel: 'Invert Mode', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8294 (III 8460 would mis-address)
  { family: 'GLOBAL', paramId: 8645, name: 'GLOBAL_DOWNTUNE', displayLabel: 'Downtune', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8645 (III 133 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 8682, name: 'GLOBAL_FC_BANK_LIMITS', displayLabel: 'Sw. Limits', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8682 (III 8462 would mis-address)
  { family: 'GLOBAL', paramId: 8683, name: 'GLOBAL_SPRK_MODEL', displayLabel: 'Spkr Imp. Curve', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8683 (III 8463 would mis-address)
  { family: 'GLOBAL', paramId: 8684, name: 'GLOBAL_USB_1_2_PLAYBACK', displayLabel: 'USB 1,2 Playback Destination', unit: 'unverified' },
  { family: 'GLOBAL', paramId: 8686, name: 'GLOBAL_FC_STARTUP_WINDOW_FC1', displayLabel: '1', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8686 (III 8465 would mis-address)
  { family: 'GLOBAL', paramId: 8687, name: 'GLOBAL_FC_STARTUP_WINDOW_FC2', displayLabel: '2', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8687 (III 8466 would mis-address)
  { family: 'GLOBAL', paramId: 8688, name: 'GLOBAL_FC_STARTUP_WINDOW_FC3', displayLabel: '3', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 8688 (III 8467 would mis-address)
  { family: 'GLOBAL', paramId: 14871, name: 'GLOBAL_INPUT_GAIN', displayLabel: 'Input 1 Gain', unit: 'numeric' }, // inferred from AxeEdit III XML controlType; device-true 14871 (III 8367 would mis-address)
  { family: 'GLOBAL', paramId: 14873, name: 'GLOBAL_GAP_FILL', displayLabel: 'Gapless', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 14873 (III 14650 would mis-address)
  { family: 'GLOBAL', paramId: 14874, name: 'GLOBAL_RCV_MIDI_CLOCK', displayLabel: 'Rcv MIDI Clk', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 14874 (III 14651 would mis-address)
  { family: 'GLOBAL', paramId: 14875, name: 'GLOBAL_SEND_MIDI_CLOCK', displayLabel: 'Snd MIDI Clk', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 14875 (III 14652 would mis-address)
  { family: 'GLOBAL', paramId: 14878, name: 'GLOBAL_METRONOME', displayLabel: 'Metronome', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 14878 (III 14655 would mis-address)
  { family: 'GLOBAL', paramId: 14879, name: 'GLOBAL_METRONOME_CC', unit: 'unverified' }, // device-true 14879 (III 14656 would mis-address)
  ...
  { family: 'REVERB', paramId: 1, name: 'REVERB_TIME', displayLabel: 'Time', unit: 'seconds', displayMin: 0.1, displayMax: 100 }, // inferred from AM4
  { family: 'REVERB', paramId: 2, name: 'REVERB_HICUT', displayLabel: 'High Cut Frequency', unit: 'hz', displayMin: 200, displayMax: 20000 }, // inferred from AM4
  { family: 'REVERB', paramId: 3, name: 'REVERB_HFRATIO', displayLabel: 'High Decay', unit: 'numeric' }, // inferred from AxeEdit III XML controlType
  { family: 'REVERB', paramId: 4, name: 'REVERB_DIFFUSION', displayLabel: 'Wall Diffusion', unit: 'percent', displayMin: 0, displayMax: 100 }, // inferred from AM4
  ...
  { family: 'REVERB', paramId: 25, name: 'REVERB_WIDTH', displayLabel: 'Mic Spacing', unit: 'numeric' }, // inferred from AxeEdit III XML controlType
  { family: 'REVERB', paramId: 26, name: 'REVERB_FREQ1', displayLabel: 'Freq 1', unit: 'hz', displayMin: 20, displayMax: 2000 }, // inferred from AM4
  { family: 'REVERB', paramId: 27, name: 'REVERB_FREQ2', displayLabel: 'Freq 2', unit: 'hz', displayMin: 100, displayMax: 10000 }, // inferred from AM4
  { family: 'REVERB', paramId: 28, name: 'REVERB_Q1', displayLabel: 'Q 1', unit: 'count', displayMin: 0.1, displayMax: 10, scaling: 'log10' }, // inferred from AM4
  { family: 'REVERB', paramId: 29, name: 'REVERB_Q2', displayLabel: 'Q 2', unit: 'count', displayMin: 0.1, displayMax: 10, scaling: 'log10' }, // inferred from AM4
  { family: 'REVERB', paramId: 30, name: 'REVERB_GAIN1', displayLabel: 'Gain 1', unit: 'db', displayMin: -12, displayMax: 12 }, // inferred from AM4
  ...
  { family: 'REVERB', paramId: 52, name: 'REVERB_KILLDRY', displayLabel: 'Kill Dry', unit: 'enum' }, // inferred from AxeEdit III XML controlType; device-true 52 (III 68 would mis-address)
...
export const FM3_PARAMS_BY_FAMILY: Readonly<Record<string, readonly Param[]>> = (() => {
