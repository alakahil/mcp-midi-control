...
export const FM3_RANGES = {
  CABINET: {
    ...
    // CABINET_BASS - FM3 fw 13 hardware-validated, 2026-08-21.
    ...
    // CABINET_TREBLE - FM3 fw 13 hardware-validated, 2026-08-21.
    // GET-only: -12 dB=0; 0 dB=32767; +12 dB=65534.
    46: {
      kind: 'float',
      displayMin: -12,
    ...
    // CABINET_LOCUT - FM3 fw 13 hardware-validated, 2026-08-21.
    // Log10 scaling across 20..2000 Hz:
    // 20 Hz -> raw 0; 60 Hz -> raw 15634; 2000 Hz -> raw 65534.
    38: {
      kind: 'float',
      displayMin: 20,
      displayMax: 2000,
    ...
    // CABINET_ZOOM - FM3 fw 13 hardware-validated, 2026-08-21.
    // GET-only live diff: OFF -> raw 0; ON -> raw 1.
    40: {
      kind: 'float',
      displayMin: 0,
      displayMax: 1,
